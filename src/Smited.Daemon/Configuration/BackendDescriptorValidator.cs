...
internal static partial class BackendDescriptorValidator
{
    ...
    private static readonly IReadOnlySet<string> SingletonKinds =
        new HashSet<string>(StringComparer.OrdinalIgnoreCase)
        {
            ...
            "owo_skin",
            // MockBhapticsBackend is a DI singleton (IMockBhapticsController
            // is wired to the same instance) — same overrides-collision
            // shape as mock_owo.
            "mock_bhaptics",
            // BhapticsBackend connects to a single bHaptics Player
            // WebSocket on localhost:15881; the Player exposes one
            // endpoint per machine and two backends would race on the
            // socket. Two enabled descriptors of this kind would also
            // produce mutually-conflicting reconnect loops.
            "bhaptics_tactsuit",
        };
